...
@section('content')
    <section class="section">
        <form id="form-register" class=" mx-auto col-xl-7 col-lg-7 col-md-10 col-sm-12 col-12 p-xl-5 p-2 my-5 " action="{{route('website.passwordreset.store')}}" method="post">
            @csrf
            ...
            <div class="text-center font-18 mt-5">برای تغییر رمز عبور ایمیل خود را وارد نمایید</div>
            <div class="mt-5">
