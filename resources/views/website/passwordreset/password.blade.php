...
@section('content')
    ...
    <section class="section">
        <form id="form-register" action="{{route('website.passwordreset.password.update',$PasswordReset)}}" class=" mx-auto col-xl-7 col-lg-7 col-md-10 col-sm-12 col-12 p-xl-5 p-2 my-5 " method="post">
            @csrf
            @method('PATCH')
            <div class="text-center mt-5"><img src="/website/icon/password.png" class="icon-password">رمز عبور جدید را وارد نمایید.</div>
            <div class="mt-5">
