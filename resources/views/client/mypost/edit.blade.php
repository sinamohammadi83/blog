...
@section('content')
    ...
    <div class="d-inline-block col-xl-12 col-lg-12 col-md-12 col-sm-12">
        <h3 class="p-3 text-center text-lg-end">ویرایش پست {{$post->title}}</h3>
        <div class="mx-auto col-xl-9 col-lg-10 col-md-10 col-sm-10 col-12 pt-5">
            <form action="{{route('client.myposts.update',$post)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="form-group mt-3">
                    <div class="border col-4">
                        <img src="{{$post->ImagePath}}" class="col-12" alt="">
                    </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea type="text" name="content" id="editor1" rows="8" class="form-control">{{$post->content}}</textarea>
                </div>
                <div class="form-group mt-5">
                    ...
                    <input type="checkbox" @if($post->comment) checked @endif class="newcheckbox" name="comment">
                ...
                <div class="form-group mt-5">
                    ...
                    <label for="">غیر فعال</label>
                    <input type="checkbox" @if($post->is_published) checked @endif class="newcheckbox" name="published">
                    <label for=""> فعال</label>
